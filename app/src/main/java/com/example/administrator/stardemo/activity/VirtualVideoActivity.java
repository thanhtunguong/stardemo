...
public class VirtualVideoActivity extends AppCompatActivity {
    ...
    private static final String TAG = VirtualVideoActivity.class.getSimpleName();
    ...
    private String congoVideo = "congo.mp4";
    private String sphericalv2Video = "sphericalv2.mp4";
    ...
    private void setIsMuted(boolean isMuted) {
        ...
        volumeToggle.setImageResource(isMuted ? R.drawable.ic_volume_mute_black_24dp : R.drawable.ic_volume_up_black_24dp);
    ...
    private class ActivityEventListener extends VrVideoEventListener {
        ...
        public void onLoadError(String errorMessage) {
            ...
            Toast.makeText(
                    VirtualVideoActivity.this, "Error loading video: " + errorMessage, Toast.LENGTH_LONG)
                    .show();
        ...
        protected Boolean doInBackground(Pair<Uri, VrVideoView.Options>... fileInformation) {
            try {
                if (fileInformation == null || fileInformation.length < 1
                    ...
                    videoWidgetView.loadVideoFromAsset(congoVideo, options);
                } else {
                ...
                videoWidgetView.post(new Runnable() {
                    ...
                    public void run() {
                        Toast
                                .makeText(VirtualVideoActivity.this, "Error opening file. ", Toast.LENGTH_LONG)
                                .show();
                    }
                });
